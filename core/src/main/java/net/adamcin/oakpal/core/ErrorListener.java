...
public interface ErrorListener extends ScanListener, ViolationReporter {
    ...
    /**
     * Called for an IOException or RepoInitParsingException when parsing an installable repoinit script discovered
     * by a JcrInstallWatcher.
     *
     * @param error       the error thrown
     * @param lastPackage the id of the last preinstalled or scanned package
     * @param installable the repoinit installable
     */
    default void onInstallableRepoInitError(final Throwable error,
                                            final PackageId lastPackage,
                                            final RepoInitInstallable installable) {
    }

    /**
     * Called for an IOException, PackageException, or RepositoryException when installing a subpackage discovered
     * by a JcrInstallWatcher.
     *
     * @param error       the error thrown
     * @param lastPackage the id of the last preinstalled or scanned package
