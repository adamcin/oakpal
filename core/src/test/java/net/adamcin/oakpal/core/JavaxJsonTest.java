...
public class JavaxJsonTest {
    ...
    public void testWrap() {
        ...
        final Map<Integer, JcrNs> convMap = Collections
                .singletonMap(5, JcrNs.create(prefix, uri));
        assertEquals("convert map to json obj",
                key("5", key(JcrNs.KEY_PREFIX, prefix).key(JcrNs.KEY_URI, uri)).get(), wrap(convMap));
